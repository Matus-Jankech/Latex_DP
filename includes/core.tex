...
\begin{enumerate}
    ...
    \item Adaptívne podvzorkovanie bodov objektov
...
\newline\indent V poslednom rade sme sa zamerali na dôveryhodnosť povrchu, kde sme si všimli, že rekonštrukcia má problém s úzkymi objektami vegetáciou (Obr. \ref{fig:cable_mesh} a \ref{fig:tree_mesh}), pričom tento efekt bol posilnený neuplným odstránením polygónov na hranách objektu.
