...
\begin{figure}[ht]
  \centering
  \includegraphics[width=10cm, height=21cm]{img/mesh_methods_compararison.png}
  \caption{Porovnanie rôznych metód rekonštrukcie povrchu na objekte auta - (1) Podvzorkované mračno bodov (2) \acrshort{gpt} (3) Marching cubes (4) Poissonová rekonštrukcia ($SD1$)} 
