...
\begin{figure}[ht]
  \centering
  \includegraphics[width=16cm, height=10cm]{img/mesh_bad_normals.png}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=16cm, height=5.5cm]{img/decimation_results.png}
...
\newpage\subsection{Textúrovanie povrchu}
